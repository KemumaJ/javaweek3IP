package com.kenyawild;

import com.kenyawild.dao.impl.AnimalDAOImpl;
import com.kenyawild.dao.impl.EndangeredAnimalDAOImpl;
import com.kenyawild.dao.impl.SightingDAOImpl;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        post("/", (req, res) -> {
            ...
            Sighting sighting = new Sighting(animalId, location, Constants.ANIMAL, rangerName);
            if (endangered != null && !endangered.isBlank() && endangered.equals("on")) {
                ...
                sighting.setType(Constants.ENDANGERED);
            }
